                ...
                <div className="flex flex-wrap items-center justify-center -mx-4">
                    <div className="mb-16 lg:mb-0 max-w-2xl lg:w-1/2 px-4">
                        <a className="mb-6 inline-block text-3xl font-bold leading-none" href="#">
                            <img className="h-12" src="atis-assets/logo/atis/Rev-Logo.png" alt="" width="auto"/>
                        </a>
                        ...
                        <a className="inline-block py-2 px-6 bg-[#5386E4] hover:bg-[#5386E4] text-white font-bold leading-loose transition duration-250 rounded-l-xl rounded-t-xl" href="#">
                            Get Started
                        </a>
                    </div>
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="max-w-sm mx-auto lg:mr-0 lg:ml-auto">
                            <div className="mb-6 py-8 px-6 bg-white shadow rounded-t-3xl rounded-bl-3xl text-center">
                                <form action="">
                                    <div className="mb-6">
                                        <span className="text-sm text-gray-400">Any Query!</span>
                                        <h4 className="text-2xl">Fill the Form, Then Relax. </h4>
                                    </div>
                                    ...
                                    <button className="mb-4 py-4 w-full rounded text-sm bg-[#5386E4] hover:bg-[#5386E4] text-white font-bold leading-normal transition duration-200">
                                        Send
                                    </button>
                                </form>
                            </div>
