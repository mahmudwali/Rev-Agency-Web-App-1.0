        ...
        <section className="py-20">
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap">
                    ...
                    <div className="mb-8 w-full md:w-1/2 lg:w-1/4 text-center">
                        <span className="mb-6 inline-block p-4 rounded bg-[#d8e5fd]">
                            <svg className="w-6 h-6 text-[#5386E4]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="mb-8 w-full md:w-1/2 lg:w-1/4 text-center">
                        <span className="mb-6 inline-block p-4 rounded bg-[#d8e5fd]">
                            <svg className="w-6 h-6 text-[#5386E4]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
