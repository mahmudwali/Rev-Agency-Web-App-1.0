                                ...
                                <div className='w-full text-center lg:text-left'>
                                    <div className='max-w-md mx-auto lg:mx-0'>
                                        <h2 className='mb-3 text-4xl lg:text-5xl font-bold font-heading'>
                                            ...
                                            <span className='text-[#5386E4]'>problems</span>
                                        </h2>
                                    </div>
                                    <div className='max-w-sm mx-auto lg:mx-0'>
                                        ...
                                        <div>
                                            <Link className='inline-block mb-3 lg:mb-0 lg:mr-3 w-full lg:w-auto py-2 px-6 leading-loose bg-[#5386E4] hover:bg-[#2a74fc] text-white font-semibold rounded-l-xl rounded-t-xl transition duration-200' href='#'>Get Started</Link>
                                            <Link className='inline-block w-full lg:w-auto py-2 px-6 leading-loose font-semibold border hover:border-[#2a74fc] rounded-l-xl rounded-t-xl transition duration-200' href='#'>How it works</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
